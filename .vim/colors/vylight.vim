...
hi Normal        guifg=#1a1a1a  guibg=#cdcdcd
hi Title         guifg=black    guibg=#cdcdcd
hi Cursor        guibg=#111111
hi LineNr        guifg=#aaaaaa  guibg=#f8f8f8
hi Visual        guibg=#bbddff
hi NonText       guifg=#cccccc  guibg=#cdcdcd
hi StatusLine    guifg=#333333  guibg=#000000  gui=none
hi StatusLineNC  guifg=#666666  guibg=#000000  gui=none
...
hi Error         guifg=#bb3355  guibg=#cdcdcd  gui=none
...
if version >= 700
  ...
  hi PmenuSel    guifg=#CDCDCD  guibg=#3585ef  gui=bold
...
"hi Todo          guifg=#225522  guibg=#cdcdcd    gui=italic
